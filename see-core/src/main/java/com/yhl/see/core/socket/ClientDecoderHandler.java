...
public class ClientDecoderHandler extends LengthFieldBasedFrameDecoder {

    private static final int HEADER_SIZE = 4;

    private static final Logger logger = LoggerFactory.getLogger(ClientDecoderHandler.class);

    public ClientDecoderHandler(int maxFrameLength,
